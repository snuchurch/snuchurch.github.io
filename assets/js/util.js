...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Add your logic to update the page content based on the language
	if (lang == "en") {
		$('[lang]').hide();
		$('[lang="en"]').show();
	}
...
document.querySelectorAll('.language-selector').forEach(function(element) {
...
// 	$('[lang="en"]').show();
// });
// $('#lang-switch-to-ko').on('click', function () { 
// 	$('[lang]').hide();
// 	$('[lang="ko"]').show();
// });
